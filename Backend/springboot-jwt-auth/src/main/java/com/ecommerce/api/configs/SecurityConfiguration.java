    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeRequests(authorize -> authorize
                        ...
                        .requestMatchers(new AntPathRequestMatcher("/api/product/filter", "GET")).permitAll() // Allow GET requests to /api/products/filter without authentication
                        .requestMatchers(new AntPathRequestMatcher("/api/product/*", "GET")).permitAll() // Allow GET requests to /api/products/{id} without authentication
